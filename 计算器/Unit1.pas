...
begin
  if flag=0 then
    begin
      button9.Caption := 'e^x';
      button10.Caption := 'logy(x)';
      button11.Caption := '2^x';
      button12.Caption := '3√x';
      button13.Caption := 'y√x';
      button14.Caption := 'x^3';
      flag := 1;
    end
  else
    begin
      button9.Caption := 'ln';
      button10.Caption := 'log';
      button11.Caption := '10^x';
      button12.Caption := 'x^y';
      button13.Caption := '√x';
      button14.Caption := 'x^2';
      flag := 0;
    end;
end;
...
edit1.SetFocus;
  ...
  begin
      if (Edit1.Text[i]='+')or (Edit1.Text[i]='-')or
         (Edit1.Text[i]='*')or (Edit1.Text[i]='/')or
         (Edit1.Text[i]='%') then
         MessageBeep(MB_OK)
      else
         Edit1.Text:=Edit1.Text+'%';
...
edit1.SetFocus;
  ...
  begin
      if (Edit1.Text[i]='+')or (Edit1.Text[i]='-')or
         (Edit1.Text[i]='*')or (Edit1.Text[i]='/')or
         (Edit1.Text[i]='%')or (Edit1.Text[i]='e')then
         MessageBeep(MB_OK)
      else
  ...
  L:=1;
   ...
   for a:=2 to j do
    ...
    if mun1[k]='+' then
      ...
      data2:= Real(Round(data) Mod Round(data1))
    else if mun1[k]='e' then
      data2:= Real(Round(data)*(exp(Round(data1)*ln(10))));
    k:=k+1;
    data:= data2;
    end;
